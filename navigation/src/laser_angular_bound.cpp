...
double lower_angle_ = -1.7;
double upper_angle_ = 1.7;
...
int main(int argc, char** argv){
  ros::init(argc, argv, "laser_angular_bound_filter");
  ros::NodeHandle n1, n2;
  input_scan_sub = n1.subscribe("/scan_unfiltered", 10, input_scan_sub_callback);
  filtered_scan_pub = n2.advertise<sensor_msgs::LaserScan>("/scan", 50);
